...
\begin{tikzpicture}
  ...
  \node[stepbox, right=0.8cm of deploy] (call)   {{\Large\bfseries Call it}\\[0.3em] 2 different ways};
...
% =====================================================================
\begin{frame}{2 ways to call your contract}
\vspace{0.6em}
\centering

\begin{tikzpicture}
  \node[stepbox, fill=blue!10]                       (w1) {{\large\bfseries 1. Explorer}\\[0.3em] click buttons\\ on Arbiscan};
  \node[stepbox, fill=blue!20, right=0.8cm of w1]    (w2) {{\large\bfseries 2. Script}\\[0.3em] TypeScript,\\ the way a dApp does};
\end{tikzpicture}

\vspace{1.4em}
{\large Same contract. Two angles to understand it.}\\[0.5em]
